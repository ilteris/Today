...
class BlurbTransitionManager: UIPercentDrivenInteractiveTransition, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate, UIViewControllerInteractiveTransitioning {
    ...
    func animateTransition(transitionContext: UIViewControllerContextTransitioning) {
        ...
        let menuViewController = !self.presenting ? screens.from as! BlurbAddViewController : screens.to as! BlurbAddViewController
        let topViewController = !self.presenting ? screens.to as! MainViewController : screens.from as! MainViewController
    ...
    func offStageMenuControllerInteractive(menuViewController: BlurbAddViewController){
...
//        menuViewController.audioPostLabel.transform = self.offStage(offstageOffset)
    ...
    func onStageMenuController(menuViewController: BlurbAddViewController){
