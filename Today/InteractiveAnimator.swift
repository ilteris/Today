...
class InteractiveAnimator: UIPercentDrivenInteractiveTransition, UIViewControllerAnimatedTransitioning {
  ...
  func animateTransition(transitionContext: UIViewControllerContextTransitioning) {
    ...
    if operation == .Push {
     ...
     // toVC.view.transform = CGAffineTransformTranslate(toVC.view.transform, 0, -toVC.topView.bounds.size.height);

    //  fromVC.view.transform = CGAffineTransformTranslate(fromVC.view.transform, 0, -fromVC.view.frame.size.height);
